...
app = Dash(external_stylesheets=[dbc.themes.BOOTSTRAP, dbc.icons.BOOTSTRAP], external_scripts=external_scripts, use_pages=True, pages_folder='pages_11')
server = app.server
...
app.layout = html.Div([
    dbc.Navbar(
        dbc.Container(
             [html.A(
                dbc.Row([
                    dbc.Col(html.Img(src=com_logo, height="30px")),
